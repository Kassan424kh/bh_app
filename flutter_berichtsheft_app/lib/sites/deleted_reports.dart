  ...
  _getReports() {
    _api.deletedReports.then((reports) {
      ...
      for (var i = 0; i < reports.length; i++)
        _listOfReportsIds.add(reports[i]["r_id"]);
...
// Permanently delete reports button
                ...
                onPressed: () {
                  ...
                  Provider.of<MessageProvider>(context, listen: false)
                    ...
                    messageText: areReportsSelected
                        ? "Are you sure, you want to delete selected reports permanently?"
                        ...
                        ? () {
                            ...
                            _api
                              ...
                              if (permanentlyDeleted) {
                                _listOfDeletedReports.removeWhere((report) =>
        ...
        SizedBox(height: 20),
        ReportsDataTable(
          listOfReports: _listOfDeletedReports,
          nullSiteIcon: SitesIcons.nullDeletedReports,
        )
      ],
    );
  }
